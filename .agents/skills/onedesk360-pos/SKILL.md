...
name: onedesk360-pos
description: >-
  Expert engineering and operational workflows for OneDesk360 Cloud POS & Multi-Tenant
  SaaS platform. Use this skill for database migrations, tenant store provisioning,
  POS hardware & printer configurations, offline sync testing, role permissions,
  and end-to-end testing application flows.
---
