        ...
        <div className="grid gap-4 sm:gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {tables.map((table: any) => {
            ...
            return (
              <div
                key={table.id}
                className={`relative rounded-2xl border p-5 shadow-sm hover:shadow-card flex flex-col justify-between transition-all duration-300 ease-in-out group ${
                  isOccupied
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="text-xs text-muted-foreground font-medium flex items-center gap-1 mt-0.5">
                          <Utensils className="size-3" /> Cap: {table.capacity}
                        </span>
                      </div>
                    </div>
