    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[96vw] sm:max-w-3xl lg:max-w-4xl h-[90dvh] sm:h-[80vh] max-h-[720px] flex flex-col p-0 overflow-hidden rounded-3xl border-border/80 shadow-2xl bg-card">
        ...
        <div className="flex-1 min-h-0 flex flex-col md:flex-row overflow-hidden">
          ...
          <div className="w-full md:w-64 lg:w-72 max-h-[35%] md:max-h-none border-b md:border-b-0 md:border-r border-border/80 bg-muted/10 flex flex-col shrink-0">
        ...
        {/* Modal Footer */}
        <DialogFooter className="p-4 border-t border-border/80 bg-muted/20 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
