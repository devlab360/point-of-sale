...
export const REPAIR_STATUSES: OptionItem[] = [
  ...
  },
  {
    ...
    badge: "bg-emerald-600/15 text-emerald-600 border-emerald-600/30",
  },
  {
    value: "cancelled",
    label: "Cancelled / Returned Unfixed",
    badge: "bg-destructive/15 text-destructive border-destructive/30",
  },
];
